	...
	!FINDS N-TUPLEGRID POINT FROM INDEX IN COLLECTIVE VARIABLE SPACE.
	SUBROUTINE GETS
	USE GLOBAL_VAR
	IMPLICIT NONE
	S(IMETACOLVAR(1):IMETACOLVAR(NMETACOLVAR)) = GRIDMIN(IMETACOLVAR(1):IMETACOLVAR(NMETACOLVAR)) + DBLE(I(IMETACOLVAR(1):IMETACOLVAR(NMETACOLVAR)) - 1) * GRIDDIF(IMETACOLVAR(1):IMETACOLVAR(NMETACOLVAR))
	RETURN
	END SUBROUTINE
        !*****************************************************************************************!
	...
	!FINDS NMETACOLVAR-TUPLEGRID INDEX FROM POINT IN METADYNAMICS COLLECTIVE VARIABLE SPACE.
	SUBROUTINE GETIS
	USE GLOBAL_VAR
	IMPLICIT NONE
	I(IMETACOLVAR(1):IMETACOLVAR(NMETACOLVAR)) = (S(IMETACOLVAR(1):IMETACOLVAR(NMETACOLVAR)) - GRIDMIN(IMETACOLVAR(1):IMETACOLVAR(NMETACOLVAR))) / GRIDDIF(IMETACOLVAR(1):IMETACOLVAR(NMETACOLVAR)) + 1
	RETURN
	END SUBROUTINE
        !*****************************************************************************************!

	!FINDS NDIM-TUPLEGRID INDEX FROM POINT IN COLLECTIVE VARIABLE SPACE.
	SUBROUTINE GETIQ
	USE GLOBAL_VAR
	IMPLICIT NONE
	...
	CALL GETS
	DO ITER2 = 1,NMETACOLVAR
		DIFSQ = DIFSQ + (CENTER(ITER2,ITER1) - S(IMETACOLVAR(ITER2))) * (CENTER(ITER2,ITER1) - S(IMETACOLVAR(ITER2)))
	ENDDO
	RETURN
	END FUNCTION
        !*****************************************************************************************!
	...
	INTEGER FUNCTION IBIAS
	USE GLOBAL_VAR
	IMPLICIT NONE
	INTEGER ITER1
	INTEGER*8 DUMMY1
	DUMMY1 = NMETACOLVARGRID
	IBIAS = I(IMETACOLVAR(1))
	DO ITER1 = NMETACOLVAR,2, - 1
		DUMMY1 = DUMMY1/NBIN((IMETACOLVAR(ITER1)))
		IBIAS = IBIAS + DUMMY1 * (I(IMETACOLVAR(ITER1) - 1))
	ENDDO
	RETURN
	END FUNCTION
        !*****************************************************************************************!
