	...
	!*) FSMOOTH		:	FACTOR FOR GRID BLURRING.
	!*************************************************************!
	...
	INTEGER, DIMENSION(:), ALLOCATABLE :: NBIN, IQ, I
	!HILLS VARIABLES.
	...
	!REWEIGHTING.
	INTEGER NHILLMIN, NHILLMAX, CDUMP, FSMOOTH
	REAL*8 CNUM, CDEN
	LOGICAL REWEIGHT
	REAL*8, DIMENSION(:), ALLOCATABLE :: GRIDPOINT, PROB, C, CNUMER, CDENOM
	!FILES.
	CHARACTER (LEN = 100) INPUTFILE, LOGFILE, OUTPUTFILE1, OUTPUTFILE2, ERRORFILE, CFILE, CVFILE
	LOGICAL ERRORSTAT
